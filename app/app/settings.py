...
DATABASES = {
    'default': {
        ...
        'NAME': 'liles6_db1',                 # Your database name
        'USER': 'liles6',                     # Your MySQL username
...
BASE_DIR = Path(__file__).resolve().parent.parent
MEDIA_ROOT = os.path.join(BASE_DIR, 'media')
MEDIA_ROOT = '/home/liles6/development/app/media/'
FORCE_SCRIPT_NAME = '/liles6'
